        ...
        if(isset($_FILES['imagen'])) { 
            ...
            if($tipo == 1){
                ...
                if(isset($_FILES['pdf'])){
                    ...
                    echo json_encode(["Message" => "Ingrese el pdf del libro","Code" => 500]);
                }  
                ...
                if(move_uploaded_file($_FILES['imagen']['tmp_name'], $upload1)) { //movemos el archivo a su ubicacion 
                    ...
                    $response = $libro->registrar($categoria,$autor,$tipo,$nomlibro,$nombrefinal1,'');
            ...
            echo json_encode(["Message" => "Ingrese una imagen","Code" => 500]);
        }  
    //}
